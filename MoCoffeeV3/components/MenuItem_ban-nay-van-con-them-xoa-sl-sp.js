...
const MenuItem = ({
  item,
  handleHideQuantityCalculator,
  handleShowQuantityCalculator,
}) => {
        ...
        <Pressable
          ...
          {item?.isShowQuantityCalculator ? (
            <Pressable
              ...
              <Pressable
                onPress={() => {
                  if (additems == 1 || additems < 1 || additems === 0) {
                    ...
                    // remove UI
                    handleHideQuantityCalculator(item.id);
                    return;
                  }
                  setAddItems(c => c - 1);
                  dispatch(decrementQuantity(item));
            ...
            <Pressable
              onPress={() => {
                ...
                handleShowQuantityCalculator(item.id);
              }}
              style={{
                position: 'absolute',
                top: 95,

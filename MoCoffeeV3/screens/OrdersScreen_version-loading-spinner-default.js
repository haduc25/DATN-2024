...
export default function OrdersSceen({navigation}) {
  ...
  useEffect(() => {
    // Giả lập quá trình loading trong 3 giây
  ...
  return (
    <View
      ...
      />
      <TouchableOpacity onPress={() => setIsLoadingSpinner(!isLoadingSpinner)}>
      ...
      {/* Sử dụng FlatList để hiển thị dữ liệu người dùng (TẠM TẮT) */}

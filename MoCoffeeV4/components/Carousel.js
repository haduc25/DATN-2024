...
const Carousel = () => {
  ...
  // image tạm thời
  const images = [
    // require('../assets/banner/cafe-photo-banner-1.jpg'),
    // require('../assets/banner/cafe-photo-banner-2.jpg'),
    // require('../assets/banner/juice-banner-1.jpg'),
    // require('../assets/banner/juice-banner-2.jpg'),
    // require('../assets/banner/kem-banner-2.jpg'),
    // require('../assets/banner/matcha-banner-1.jpg'),
    // require('../assets/banner/smoothie-banner-1.jpg'),
    // require('../assets/banner/smoothie-banner-2.jpg'),
